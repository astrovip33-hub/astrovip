(function(){
  ...
  function build(){
    ...
    const manage=document.createElement('button');manage.type='button';manage.className='av-consent__manage';manage.id='av-consent-manage';manage.textContent='Setări cookie';manage.hidden=true;const footer=document.querySelector('footer .wrap')||document.querySelector('footer')||document.body;footer.appendChild(manage);
